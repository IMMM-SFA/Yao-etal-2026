...
for crop in ['corn']:
    ## near future
    df_345c_nf = pd.read_csv(f'{path}sensitivity_analyses/median_nondrought_reference_yield/{crop}_financial_loss_nf_3_45_c_2021-2055.csv')
    df_585c_nf = pd.read_csv(f'{path}sensitivity_analyses/median_nondrought_reference_yield/{crop}_financial_loss_nf_5_85_c_2021-2055.csv')
    df_345h_nf = pd.read_csv(f'{path}sensitivity_analyses/median_nondrought_reference_yield/{crop}_financial_loss_nf_3_45_h_2021-2055.csv')
    df_585h_nf = pd.read_csv(f'{path}sensitivity_analyses/median_nondrought_reference_yield/{crop}_financial_loss_nf_5_85_h_2021-2055.csv')
...
plt.savefig(f'{path}sensitivity_analyses/median_nondrought_reference_yield/financial_loss_345diff585_corn_mean.png', dpi=300, bbox_inches='tight')
print ('done')