...
future_path = '/filepath/sensitivity_analyses/ssmi_threshold_-1/'
hist_path = '/filepath/sensitivity_analyses/ssmi_threshold_-1/'
climate_change_only_path = '/filepath/sensitivity_analyses/ssmi_threshold_-1/'
...
for idx, crop in enumerate(['corn', 'soybean']):
    ...
    if crop == 'corn':
        ax.set_xlim(-12, 65)
    else:  # soybean (5. Removed explicit wheat xlim check)
        ax.set_xlim(-12, 130)
...
plt.savefig(f'{future_path}production_loss_contribution_2bars_with_range_errorbars_cornsoybeanonly.png',
